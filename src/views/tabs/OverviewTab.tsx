...
import type { MediatorScores } from '../../components/layout/CopilotLevers';
...
export const OverviewTab: React.FC<OverviewTabProps> = ({ patient, mediators }) => {
  ...
  const deltaChanges = calculateMortalityDelta(mediators);
  const hasInterventions = mediators && (
  ...
  const hospitalizationReduction = {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          {hasInterventions && hospitalizationReduction['30d'] > 0 && (
            <div className="mt-3 p-2 bg-rs-green/10 border border-rs-green/30 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-xs text-renal-muted">With Interventions:</span>
                <span className="text-sm font-bold text-rs-green">{Math.max(0, patient.hospitalizationRisk['30d'] - hospitalizationReduction['30d']).toFixed(1)}%</span>
              </div>
        ...
        >
          ...
          {/* Delta Change from Interventions */}
          {hasInterventions && deltaChanges['30d'] > 0 && (
            <div className="mt-3 p-2 bg-rs-green/10 border border-rs-green/30 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-xs text-renal-muted">With Interventions:</span>
        ...
        >
          ...
          {/* Delta Change from Interventions */}
          {hasInterventions && deltaChanges['90d'] > 0 && (
            <div className="mt-3 p-2 bg-rs-green/10 border border-rs-green/30 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-xs text-renal-muted">With Interventions:</span>
        ...
        >
          ...
          {/* Delta Change from Interventions */}
          {hasInterventions && deltaChanges['1yr'] > 0 && (
            <div className="mt-3 p-2 bg-rs-green/10 border border-rs-green/30 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-xs text-renal-muted">With Interventions:</span>
